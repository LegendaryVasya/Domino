...
class Domino:
    ...
    def __init__(self):
        self.full_domino_set = [[2, 5], [1, 2], [3, 6], [0, 0], [0, 2], [5, 6], [3, 5], [2, 4], [3, 4], [1, 5], [0, 4],
                                [2, 6], [3, 3],
                                [1, 1], [1, 4], [1, 3], [2, 3], [4, 5], [2, 2], [0, 3], [0, 6], [5, 5], [4, 4], [4, 6],
                                [0, 1], [0, 5],
                                [1, 6], [6, 6]]
        self.stock_pieces = []
    ...
    def computer_ai_algorithm(self):
        ...
        for domino in self.computer_pieces:
            left_size = count_dictionary[domino[0]]
            right_size = count_dictionary[domino[1]]
            score_list.append(left_size + right_size)
    ...
    #             # break
    #             if self.computer_pieces[computer_input][0] == self.domino_snake[-1][1]:
    #                 self.domino_snake.append(self.computer_pieces[computer_input])
    #                 self.computer_pieces.remove(self.computer_pieces[computer_input])
    #                 break
    #             elif self.computer_pieces[computer_input][1] == self.domino_snake[-1][1]:
    #                 flip_piece = self.computer_pieces[computer_input]
    #                 flip_piece.reverse()
    #                 self.domino_snake.append(flip_piece)
    #                 self.computer_pieces.remove(self.computer_pieces[computer_input])
    #                 break
    ...
    #             computer_input = abs(computer_input) - 1
    ...
    #             # break
    #             if self.computer_pieces[computer_input][1] == self.domino_snake[0][0]:
    #                 self.domino_snake.insert(0, self.computer_pieces[computer_input])
    #                 self.computer_pieces.remove(self.computer_pieces[computer_input])
    #                 break
    #             elif self.computer_pieces[computer_input][0] == self.domino_snake[0][0]:
    #                 flip_piece = self.computer_pieces[computer_input]
    #                 flip_piece.reverse()
    #                 self.domino_snake.insert(0, flip_piece)
    #                 self.computer_pieces.remove(self.computer_pieces[computer_input])
